  ...
  forms.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      postData('./assets/server.php', formData).then(res => {
        ...
        console.log(res);
      }).catch(() => userMessage.textContent = message.failure).finally(() => {
        clearInputs();
        setTimeout(() => {
          userMessage.remove();
...
const modals = () => {
  function bindModal(triggerSelector, modalSelector, closeSelector, closeByOverlay = true) {
    const triggers = document.querySelectorAll(triggerSelector),
          ...
          windows = document.querySelectorAll('[data-modal]'); //   inputs = document.querySelectorAll('.popup_calc_content input'),
    //   checkboxes = document.querySelectorAll('.checkbox');
